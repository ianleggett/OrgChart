...
import webtool.security.GenericResponse;
...
//	}
	...
	public ModelAndView runtimeError(final RuntimeException ex, final WebRequest request) {
		logger.error("Exception RuntimeException", ex);
		 ModelAndView mav = new ModelAndView();
		    mav.addObject("exception", ex);
		    mav.addObject("message", ex.getMessage());
		    mav.addObject("url", request.getSessionId());
		    mav.setViewName("error");
		    return mav;
	}
	@ExceptionHandler({ InternalAuthenticationServiceException.class })
	public ModelAndView authenticationException(final RuntimeException ex, final WebRequest request) {
		logger.error("Exception InternalAuthenticationServiceException", ex);
		 ModelAndView mav = new ModelAndView();
		    mav.addObject("exception", ex);
		    mav.addObject("message", ex.getMessage());
		    mav.addObject("url", request.getSessionId());
