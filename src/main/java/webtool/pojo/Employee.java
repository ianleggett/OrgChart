...
public class Employee {
	...
	public static Employee from(Person per) {
		return new Employee(per.iNum,per.firstName,per.lastName,per.city,per.contrType,per.descr,per.jobCat,per.jobTitle,per.started,per.geoReg,per.email,per.vendor);
	}
	...
	public Employee(String inum, String firstName, String lastName, String city, String contrType, String descr,
			String jobCat, String jobTitle, String started, String geoReg, String email, String vendor) {
		super();
		this.inum = inum;
